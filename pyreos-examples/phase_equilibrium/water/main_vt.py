...
# parameters = CubicParameters.from_records([pr], cubic_model = "pr78", alpha_model = "twu91")
...
# v0 = 1.1 * (1.8970510424824202e-5 - 5.3041 / 1e6 )
...
#         vp[i] = model.pressure(300.0, 1 / v , np.array([1.]))
#         print(i, vp[i])
...
# plt.vlines(1.1 * (1.8970510424824202e-5 - 5.3041 / 1e6), -4000, 6000, linestyles="dashed", color="black")
# plt.hlines(1, 1e-5, 1e-3, linestyles="dashed", color="black")

# plt.ylim(-4000, 2000)
# plt.xlim(1e-5, 1e-3)

# plt.semilogx(vv, vp / 1e5, "-")
# # plt.plot(vv, vp / 1e5, "-")
...
#     print(i, t, PRES[i-1] if i>0 else 1e5)
