...
mod tests {
    ...
    use crate::{models::cubic::tests::recipes,};
    ...
    fn liquid_hexane_dehlouz_case1() {
        ...
        let cub = recipes::nhexane_dehlouz();
        ...
        let scrit = Arc::new(State::new_tp(eos.clone(), 507.60, 30.25 * 1e5, Some(Liquid)).unwrap()).tv_entropy() / R_GAS;
