...
fn test_association_helmholtz() {
    ...
    let a = asc.helmholtz(&x, &unbonded);
...
//     let k = array![[0.           , 0.83518048731],
//                                                  [0.83518048731, 0.           ]];
//     let dk_dt =  array![[0.0, -1.8104627059679654],
//  [-1.8104627059679654, 0.0]];
//     let s = asc.r_entropy(t, &x, &k, &dk_dt);
...
fn test_association_pressure() {
    ...
    // let z = ;
    assert_relative_eq!(- asc.df_dv(h, d, 6.9352666490453005 * 1e-6) / d, -945.9409464127781 / d, epsilon = 1e-9)
}
#[test]
fn test_association_chem_pot() {
    ...
    let mu = asc.df_dn(h, &array![0.00693526664905], &unbonded);
