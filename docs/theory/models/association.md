...
$A, B$ and $C$. $A$ and $B$ sites can interact with all sites except with sites of the same type, while $C$ sites can interact with all types of sites, including themselves.
<!-- ![alt text](grid.png) -->
