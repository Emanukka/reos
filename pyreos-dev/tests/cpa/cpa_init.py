...
bin = CPABinaryRecord.new(id1="water", id2="carbon_dioxide", **data)
...
pr1 = CPAPureRecord.new(name = "water", molar_weight = 18.01528 , **cubic, **assoc)
...
p = CPAParameters.from_records([pr1], **opt)
